...
st.write("STEP 2: Sidebar refresh button + auto-refresh toggle...")
...
with tabs[0]: appmod.tab_holdings(enriched)
with tabs[1]: appmod.tab_allocation(enriched, k)
with tabs[2]: appmod.tab_watchlist()
with tabs[3]: appmod.tab_realised(realised)
with tabs[4]: appmod.tab_history(k)
with tabs[5]: appmod.tab_transactions()
with tabs[6]:
